...
class COCOTextDataset(GenericDataset):
    ...
    def __init__(self, base_folder = DEFAULT_COCOTEXT, annots_name='cocotext.v2.json', split = 'train',
                 langs = ['english', 'non-english'], legibility = ['legible', 'illgible'], style = ['machine-printed', 'handwritten'],
        ...
        for img in valid_images:
            for annot in img['annots']:
                ...
                if annotation['class'] in style and annotation['legibility'] in legibility and annotation['language'] in langs:
        ...
        self.split = split + '_'.join(langs + legibility + style)
        ...
        def __getitem__(self, idx):
            ...
            image = Image.open(metadata['image_path']).crop(metadata['bbx'])
